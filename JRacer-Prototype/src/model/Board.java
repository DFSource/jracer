...
/**
 * The Board Class is responsible for doing the bulk of the back-end work. It
 * does not display any data, but represents the game board and current game
 * objects.
 * 
 * @author DevFactor
 * @version 03/16/2015
...
public class Board {
	/**
	 * We need to store a representation of the data. A 2D Array or ArrayList
	 * should do the trick.
	 */
